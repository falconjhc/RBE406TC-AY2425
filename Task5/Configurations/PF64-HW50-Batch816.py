...
hyperParams = {
        'debugMode':1,
        'expID':'20250509HW-Batch816',# experiment name prefix
        'expDir': '/data-shared/server01/data1/haochuan/CharacterRecords2025May-052/',
        
        'YamlPackage': '../YamlLists/PF64-HW100/',
        
        'FullLabel0Vec': '/data-shared/server09/data0/haochuan/CASIA_Dataset/LabelVecs/PF64-Label0.txt',
        'FullLabel1Vec': '/data-shared/server09/data0/haochuan/CASIA_Dataset/LabelVecs/HW300-Label1.txt',
